...
const Signup = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  <div className='signup-wrapper'>
    ...
    <p className='signup-subtitle'>Please fill in the form to create an account</p>
    <form className='signup-form' onSubmit={handleSubmit}>
      ...
      <span className='forgot-link' onClick={() => {dispatch(clearError()); dispatch(switchAuthMode("login")); }}>Do you already have an account? Login</span>
